...
- (void) drawPlaceholderInRect: (CGRect)rect
{
    ...
    [self.placeholder drawInRect: newRect
                        withFont: self.font
...
- (void)_initialize {
    ...
    _placeholderTextColor = [Utils colorWithRGBHex: 0xFFF4F5];
    ...
    self.background = [UIImage imageNamed: @"bgTextField.png"];
}
