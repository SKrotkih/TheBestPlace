...
#pragma mark WEB authorization

- (void) webAuthorization
{
	FSWebLogin* loginViewControler = [[FSWebLogin alloc] initWithUrl: [Foursquare2 authorizationUrl]
                                                         andDelegate: self];

    [[AIAppDelegate sharedDelegate] presentModalViewController: loginViewControler];
    
}

#pragma mark FSWebLoginDelegate

- (void) webLogin: (FSWebLogin*) loginViewController
...
- (void) setUpAuthorizeCallback: (Foursquare2Callback) aCallback
{
    [Foursquare2 sharedInstance].authorizationCallback = [aCallback copy];
}
